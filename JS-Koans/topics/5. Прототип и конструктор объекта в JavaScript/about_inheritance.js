...
describe("About inheritance (about_inheritance.js)", function() {
  ...
  it("should be able to call a method on the derived object", function() {
    expect(this.swedishChef.cook()).toEqual('cooking');
  });

  it("should be able to call a method on the base object", function() {
    expect(this.swedishChef.answerNanny()).toEqual('coding');
  });
...
describe("About Crockford's inheritance improvement", function() {
  ...
  it("should be able to call a method on the base object", function() {
    expect(this.gonzo.answerNanny()).toEqual('daredevil performer');
  });
